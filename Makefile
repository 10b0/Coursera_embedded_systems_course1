...
#
# -------------------------------------------------------------------
#  MAKES for the course1 (last assessment)
# -------------------------------------------------------------------
#
#  make all COURSE=1            -> crearted all with the course1 code
#  make all COURSE=1 VERBOSE=1  -> crearted all with the course1 code and printing the arrays values
#  make clean                   -> clean all the autogenerated files
#
#------------------------------------------------------------------------------
include sources.mk
...
ifeq ($(PLATFORM), MSP432)
	...
	CFLAGS = -mcpu=$(CPU) -m$(ARCH) -march=$(MARCH) -mfloat-abi=$(FLOAT) -mfpu=$(MFPU) --specs=$(SPECS)  -DMSP432 -Wall -Werror -g -O0 -std=c99 -lm
	...
	CFLAGS = -DHOST -Wall -Werror -g -O0 -std=c99 -lm
...
%.i : %.c
	$(CC) -E $< $(CFLAGS) $(COURSEFLAG) $(VERBOSEFLAG) $(CPPFLAGS) -o $@


# Generate assembly file
# Using the -S command
%.asm : %.c
	$(CC) -S $< $(CFLAGS) $(COURSEFLAG) $(VERBOSEFLAG) $(CPPFLAGS) -o $@

# Using the objdump utility	
	$(CC) -c $< $(CFLAGS) $(COURSEFLAG) $(VERBOSEFLAG) $(LDFLAGS) $(CPPFLAGS)
	arm-none-eabi-objdump --disassemble $*.o > $*.dump

# Generate the object file
%.o : %.c
	$(CC) -c $< $(CFLAGS) $(COURSEFLAG) $(VERBOSEFLAG) $(CPPFLAGS) -o $@


# Generate all the objects files
.PHONY: compile-all
compile-all:
	$(CC) -c $(SOURCES) $(CFLAGS) $(COURSEFLAG) $(VERBOSEFLAG) $(LDFLAGS) $(CPPFLAGS)
...
$(TARGET).out: $(OBJS)
	$(CC) $(OBJS) $(CFLAGS) $(COURSEFLAG) $(VERBOSEFLAG) $(LDFLAGS) $(CPPFLAGS) -o $@
